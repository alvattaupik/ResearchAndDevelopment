...
Public Class crNonCashAndSO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Print_Struk.crNonCashAndSO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrNonCashAndSO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crNonCashAndSO = New crNonCashAndSO()
        rpt.Site = Me.Site
        Return rpt
    End Function
