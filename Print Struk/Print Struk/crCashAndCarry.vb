...
Public Class crCashAndCarry
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Print_Struk.crCashAndCarry.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrCashAndCarry
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crCashAndCarry = New crCashAndCarry()
        rpt.Site = Me.Site
        Return rpt
    End Function
