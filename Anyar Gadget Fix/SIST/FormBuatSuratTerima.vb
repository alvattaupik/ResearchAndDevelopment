...
Public Class FormBuatSuratTerima
    Sub LoadPenerima()
        txtPengirim.Text = MstrPenerima
    ...
    Private Sub FormBuatSuratTerima_Load(sender As Object, e As EventArgs) Handles Me.Load
        MstrNamaForm = "Surat Terima"
        txtPenerima.Text = MstrNamaUser
        dtpTglSurat.Value = Now

        txtPendahuluan.Text = "Pada Hari ini      Tanggal     telah diterima item sebagai berikut:"
        txtPenutup.Text = "Demikian surat terima ini dibuat agar dapat digunakan sebagaimana mestinya."
    ...
    Private Sub cmdBrowse_Click(sender As Object, e As EventArgs) Handles cmdBrowse.Click
        FormItemsSuratTerima.ShowDialog()
    End Sub
