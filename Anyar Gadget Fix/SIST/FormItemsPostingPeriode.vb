    ...
    Private Sub dgDaftarItem_Click(sender As Object, e As EventArgs) Handles dgDaftarItem.Click
        ...
        For Each drr As DataGridViewRow In dgDaftarItem.SelectedRows
            ...
            For i2 As Int32 = 0 To drr.Cells.Count - 1
                ...
                For barisatas As Integer = 0 To OpenDanClosingPeriode.dgDaftarPeriode.RowCount - 1

                    If OpenDanClosingPeriode.dgDaftarPeriode.Rows(barisatas).Cells(0).Value = dgDaftarItem.Rows(intBarisNow).Cells(0).Value Then
                        BolDuplikat = True
            ...
            If JumlahDuplikat > 0 Then
                Exit Sub
            Else
                OpenDanClosingPeriode.dgDaftarPeriode.Rows.Add(row2)
                OpenDanClosingPeriode.dgDaftarPeriode.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells
                OpenDanClosingPeriode.dgDaftarPeriode.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft
                OpenDanClosingPeriode.dgDaftarPeriode.AutoResizeColumns()
                OpenDanClosingPeriode.lblJumlahPeriode.Text = "Jumlah Periode : " & OpenDanClosingPeriode.dgDaftarPeriode.RowCount
                Me.Close()
            End If
