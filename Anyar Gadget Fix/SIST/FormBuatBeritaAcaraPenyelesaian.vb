...
Public Class FormBuatBeritaAcaraPenyelesaian
    ...
    Private Sub cmbBuatBaru_Click(sender As Object, e As EventArgs) Handles cmbBuatBaru.Click
        ...
        txtPenutup.Text = "Demikian Berita Acara ini dibuat agar dapat digunakan sebagaimana mestinya"
    End Sub
    ...
    Private Sub cmdBrowse_Click(sender As Object, e As EventArgs) Handles cmdBrowse.Click
        FormItemsBAPPenyelesaian.ShowDialog()
    End Sub
    ...
    Private Sub FormBuatBeritaAcaraPenyelesaian_Load(sender As Object, e As EventArgs) Handles Me.Load
        MstrNamaForm = "Berita Acara Penyelesaian"
        dtpTglSurat.Value = Now
        txtStaffIT.Text = MstrNamaUser
        txtSupervisor.Text = MstrSupervisor
        txtPendahuluan.Text = "Pada Hari ini       Tanggal"
        txtPenutup.Text = "Demikian Berita Acara ini dibuat agar dapat digunakan sebagaimana mestinya"
        txtSupervisor.Text = MstrSupervisor
    End Sub
    ...
    Private Sub GunaGradientButton2_Click(sender As Object, e As EventArgs) Handles GunaGradientButton2.Click
        ...
        If txtSupervisor.Text = "" Then
            MsgBox("Nama Supervisor Harus Di Isi!", vbInformation, "Penting!")
            txtSupervisor.BackColor = Color.Yellow
            Exit Sub
        End If


        If txtStaffIT.Text = "" Then
            MsgBox("Nama Staff IT Harus Di Isi!", vbInformation, "Penting!")
            txtStaffIT.BackColor = Color.Yellow
            Exit Sub
        End If
        ...
        For i As Integer = 0 To dgItem.Rows.Count - 1
            If dgItem.Rows(i).Cells(0).Value = "" And dgItem.Rows(i).Cells(1).Value = "" And dgItem.Rows(i).Cells(2).Value = "" Then
                MsgBox("Baris BAP Penyelesaian Tidak Boleh Kosong!", vbInformation, "Penting!")
                Exit Sub
            End If
        Next
        ...
        If dgItem.RowCount = 0 Then
            MsgBox("Baris BAP penyelesaian Minimal harus diisi1 baris", vbInformation, "Kosong?")
            Exit Sub
        End If
