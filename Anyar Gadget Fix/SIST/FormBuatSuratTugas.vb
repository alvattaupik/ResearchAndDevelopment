...
ErrorLoad:
    ...
    Private Sub GunaGradientButton2_Click(sender As Object, e As EventArgs) Handles GunaGradientButton2.Click
        ...
        If txtRingkasanTugas.Text = "" Then
            MsgBox("Deskripsi Tugas Surat Harus Di Isi!", vbInformation, "Penting!")
        ...
        For i As Integer = 0 To dgItem.Rows.Count - 1
            ...
            If dgItem.Rows(i).Cells(0).Value = "" And dgItem.Rows(i).Cells(1).Value = "" And dgItem.Rows(i).Cells(2).Value = "" Then
                MsgBox("Baris Surat Tugas Tidak Boleh Kosong", vbInformation, "Penting")
                Exit Sub
            End If
        ...
        If dgItem.RowCount = 0 Then
            MsgBox("Item Pegawai Tidak Boleh Kosong, Harus Minimal 1 Pegawai", vbInformation, "Kosong?")
            Exit Sub
        End If
