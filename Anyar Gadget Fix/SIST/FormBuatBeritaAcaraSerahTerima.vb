...
Public Class FormBuatBeritaAcaraSerahTerima
    ...
    Private Sub GunaGradientButton2_Click(sender As Object, e As EventArgs) Handles GunaGradientButton2.Click
        ...
        If txtStaffIT.Text = "" Then
            MsgBox("Pembuat Surat harus Di Isi!", vbInformation, "Penting!")
        ...
        For i As Integer = 0 To dgItem.Rows.Count - 1
            ...
            If dgItem.Rows(i).Cells(0).Value = "" And dgItem.Rows(i).Cells(1).Value = "" And dgItem.Rows(i).Cells(2).Value = "" Then
                MsgBox("Baris BAP Tidak Boleh Kosong", vbInformation, "Penting!")
                Exit Sub
            End If
        ...
        If dgItem.RowCount = 0 Then
            MsgBox("Baris BAP Harus berisi minimal 1 baris", vbInformation, "Penting!")
            Exit Sub
        End If
