...
Public Class Main
    ...
    Sub Koneksi()
        ...
        If MyConnection.State = ConnectionState.Closed Then
            MyConnection.Open()
        End If
        'MyConnection2 = New SqlConnection("Data Source=" + "10.1.0.53" + ";Initial Catalog=ProInt_ERP;User ID=sa;Password=h0spit4lity#")
    ...
    Private Sub n5_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles n5.TextChanged
