...
Public Class FormProsesDetaiMyRequestCloseAndOpenPostingPeriode
...
ErrorLoad:
    ...
    Private Sub cmbSetujui_Click_1(sender As Object, e As EventArgs) Handles cmbSetujui.Click
