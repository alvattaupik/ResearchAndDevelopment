...
Public Class FormBuatSuratTerima
    ...
    Private Sub FormBuatSuratTerima_Load(sender As Object, e As EventArgs) Handles Me.Load
        MstrNamaForm = "Surat Serah Terima"
        txtPenerima.Text = GlobalstrNamaUser
        dtpTglSurat.Value = Now
    End Sub

    Sub LoadPenerima()
        txtPengirim.Text = GlobalstrPenerima
    ...
    Private Sub cmdBrowse_Click(sender As Object, e As EventArgs) Handles cmdBrowse.Click
        FormItemSuratSerahTerima.ShowDialog()
    End Sub
    ...
    Private Sub cmdSimpan_Click(sender As Object, e As EventArgs) Handles cmdSimpan.Click
        ...
        If MsgBox("Apakah yakin Anda Akan Menyimpan Surat Ini?, Surat yang telah dibuat tidak dapat dihapus", vbYesNo, "Konfirmasi") = vbYes Then
            ...
            MsgBox("Surat Serah Terima Baru Berhasil Disimpan dengan Nomor Surat : " & Trim(txtNoSurat.Text), vbInformation, "Sukses!")
