...
Public Class FormKonfigurasiCetakanSurat
...
ErrorLoad:
    ...
    Sub LoadKonfigurasiSurat()
        ...
        Call KoneksiDatabase1()
        Dim cmd As New SqlCommand("SELECT * FROM V_MasterKonfigurasiSurat Where KdUser='" & Trim(GlobalstrKodeUser) & "' And Keterangan Like'%" & Trim(txtCariSettingTemplate.Text) & "%'", Koneksi1)
