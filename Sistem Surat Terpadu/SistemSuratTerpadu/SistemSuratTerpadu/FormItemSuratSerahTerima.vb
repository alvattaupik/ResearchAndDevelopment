...
Public Class FormItemSuratSerahTerima
    ...
    Private Sub dgDaftarItem_DoubleClick(sender As Object, e As EventArgs) Handles dgDaftarItem.DoubleClick
        ...
        For Each drr As DataGridViewRow In dgDaftarItem.SelectedRows
            ...
            For i2 As Int32 = 0 To drr.Cells.Count - 1
                ...
                For barisatas As Integer = 0 To FormBuatSuratTerima.dgItem.RowCount - 1

                    If FormBuatSuratTerima.dgItem.Rows(barisatas).Cells(0).Value = dgDaftarItem.Rows(intBarisNow).Cells(0).Value Then
                        BolDuplikat = True
            ...
            If JumlahDuplikat > 0 Then
                Exit Sub
            Else
                FormBuatSuratTerima.dgItem.Rows.Add(row2)
                FormBuatSuratTerima.dgItem.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells
                FormBuatSuratTerima.dgItem.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft
                FormBuatSuratTerima.dgItem.AutoResizeColumns()
                Me.Close()
            End If
        ...
        For Each drr As DataGridViewRow In dgDaftarItemLainnya.SelectedRows
            ...
            For i2 As Int32 = 0 To drr.Cells.Count - 1
                ...
                For barisatas As Integer = 0 To FormBuatSuratTerima.dgItem.RowCount - 1
                    ...
                    If FormBuatSuratTerima.dgItem.Rows(barisatas).Cells(0).Value = dgDaftarItemLainnya.Rows(intBarisNow).Cells(0).Value Then
                        BolDuplikat = True
                        JumlahDuplikat = JumlahDuplikat + 1
                    Else
