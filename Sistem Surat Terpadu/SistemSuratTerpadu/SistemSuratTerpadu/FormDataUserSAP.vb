...
Public Class FormDataUserSAP
    ...
    Private Sub dgDaftarUserSAp_Click(sender As Object, e As EventArgs) Handles dgDaftarUserSAp.Click
        If MstrNamaForm = "Cari kode User" Then
            FormUserLogin.txtKodeUser.Text = dgDaftarUserSAp.Item(0, dgDaftarUserSAp.CurrentRow.Index).Value
            FormUserLogin.txtNamaLengkap.Text = dgDaftarUserSAp.Item(1, dgDaftarUserSAp.CurrentRow.Index).Value
            Me.Close()
        End If


        If MstrNamaForm = "Cari kode SPV" Then
            FormUserLogin.txtKodeSPV.Text = dgDaftarUserSAp.Item(0, dgDaftarUserSAp.CurrentRow.Index).Value
            FormUserLogin.txtNamaSPV.Text = dgDaftarUserSAp.Item(1, dgDaftarUserSAp.CurrentRow.Index).Value
            Me.Close()
        End If
