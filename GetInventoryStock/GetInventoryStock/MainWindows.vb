...
Public Class MainWindows
    ...
    Public Sub LoadDatagridViewInventory()
        ...
        If koneksi() = True Then
            ...
            Dim cmd As New SqlCommand("SELECT [Kode Gudang],[Nama Gudang],[In Stock],Commited,[On Order] FROM V_DaftarMonitoringStok Where ItemCode Like'%" & Trim(txtKodeBarang.Text) & "%'", conn)
