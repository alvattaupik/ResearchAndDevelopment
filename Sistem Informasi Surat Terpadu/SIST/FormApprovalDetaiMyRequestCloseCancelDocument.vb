...
Imports SIST.ClassCrypt

Public Class FormApprovalDetaiMyRequestCloseCancelDocument
    ...
    Sub LoadDetailValidasi()
        ...
        If dr.HasRows = True Then
            ...
            txtNamaSPV.Text = dr.GetString(18)
...
ErrorLoad:
    ...
    Private Sub cmbSetujui_Click(sender As Object, e As EventArgs) Handles cmbSetujui.Click
