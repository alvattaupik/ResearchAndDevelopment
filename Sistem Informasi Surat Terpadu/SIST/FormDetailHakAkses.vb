...
Public Class FormDetailHakAkses
    ...
    Sub LoadDaftarHakAkses()
        ...
        Dim cmd As New SqlCommand("SELECT Distinct KodeObject,NamaKomponen,StatusEnabled FROM V_ObjectUserAplikasi  WHERE KodePegawai= '" & Trim(txtKodeUser.Text) & "' AND NamaKomponen Like '%" & txtCariHakAkses.Text & "%' Order By KodeObject ", Koneksi1)
    ...
    Private Sub cmdSimpan_Click(sender As Object, e As EventArgs) Handles cmdSimpan.Click
        ...
        For i As Integer = 0 To dgHakAksesUser.Rows.Count - 1
            ...
            cmd1.Parameters.AddWithValue("KodeAplikasi", MstrNamaAplikasi)
