...
Public Class FormChangelog
    ...
    Sub LihatDaftarBantuan()
        ...
        Dim cmd As New SqlCommand("SELECT VersiChangeLog,TanggalChangelog,PathChangeLog FROM dbo.ChangelogKonten Where VersiChangelog like '" & txtCariBantuan.Text & "%' And StatusEnabled='Y'", Koneksi1)
    ...
    Private Sub cmdLihat_Click(sender As Object, e As EventArgs) Handles cmdLihat.Click
        ...
        If strPathHelp = "" Then
            MsgBox("Tidak Ada Dokumen Changelog yang Disimpan", vbInformation, "Hubungi Administrator")
            Exit Sub
        End If
