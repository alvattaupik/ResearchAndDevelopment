...
Public Class MarginBaruV1_1
    ...
    Private Sub CopyTableToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CopyTableToolStripMenuItem.Click
        ...
        If strNamaGrid = "DataGridViewTASIKMALAYA" Then
    ...
    Private Sub AYANI_Click(sender As Object, e As EventArgs) Handles AYANI.Click
        strNamaGrid = "DataGridViewAyani"
    End Sub

    Private Sub CIBABAT_Click(sender As Object, e As EventArgs) Handles CIBABAT.Click
        strNamaGrid = "DataGridViewCibabat"
    End Sub


    Private Sub KOPO_Click(sender As Object, e As EventArgs) Handles KOPO.Click
        strNamaGrid = "DataGridViewKopo"
    End Sub


    Private Sub CIBIRU_Click(sender As Object, e As EventArgs) Handles CIBIRU.Click
        strNamaGrid = "DataGridViewCibiru"
    End Sub

    Private Sub GARUT_Click(sender As Object, e As EventArgs) Handles GARUT.Click
        strNamaGrid = "DataGridViewGarut"
    End Sub


    Private Sub CIREBON_Click(sender As Object, e As EventArgs) Handles CIREBON.Click
        strNamaGrid = "DataGridViewCirebon"
    End Sub

    Private Sub SUMEDANG_Click(sender As Object, e As EventArgs) Handles SUMEDANG.Click
        strNamaGrid = "DataGridViewSumedang"
    End Sub


    Private Sub CIPARAY_Click(sender As Object, e As EventArgs) Handles CIPARAY.Click
        strNamaGrid = "DataGridViewCiparay"
    End Sub


    Private Sub RANCAEKEK_Click(sender As Object, e As EventArgs) Handles RANCAEKEK.Click
        strNamaGrid = "DataGridViewRancaekek"
    End Sub


    Private Sub TASIKMALAYA_Click(sender As Object, e As EventArgs) Handles TASIKMALAYA.Click
        strNamaGrid = "DataGridViewTASIKMALAYA"
    End Sub


    Private Sub PAMANUKAN_Click(sender As Object, e As EventArgs) Handles PAMANUKAN.Click
