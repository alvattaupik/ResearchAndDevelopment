...
Public Class frmBrowseItemMasterDataBAPPenyelesaian
    ...
    Private Sub dgvBusinessPartner_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvItemMasterData.CellContentClick
        CType(frmMainMenu.ActiveMdiChild, frmBAPPenyelesaian).txtKode.Text = dgvItemMasterData.Rows(e.RowIndex).Cells(0).Value()
        CType(frmMainMenu.ActiveMdiChild, frmBAPPenyelesaian).txtDeskripsi.Text = dgvItemMasterData.Rows(e.RowIndex).Cells(1).Value()
