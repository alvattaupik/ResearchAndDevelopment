...
Public Class frmBrowseConfigurationItems
    ...
    Private Sub dgvBusinessPartner_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvBusinessPartner.CellContentClick
        ...
        CType(frmMainMenu.ActiveMdiChild, frmRequestFullfillment).txtSalamPembuka.Text = dgvBusinessPartner.Rows(e.RowIndex).Cells(1).Value()
        CType(frmMainMenu.ActiveMdiChild, frmRequestFullfillment).txtNoTelp.Text = dgvBusinessPartner.Rows(e.RowIndex).Cells(2).Value()
        Me.Close()
    End Sub
