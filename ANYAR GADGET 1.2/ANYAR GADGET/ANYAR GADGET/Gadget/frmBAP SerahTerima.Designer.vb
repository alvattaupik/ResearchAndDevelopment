...
Partial Class frmBAPSerahTerima
    ...
    Private Sub InitializeComponent()
        ...
        Me.GroupBox1.Text = "KOP BERITA ACARA SERAH TERIMA"
        '
        'GroupBox3
        '
