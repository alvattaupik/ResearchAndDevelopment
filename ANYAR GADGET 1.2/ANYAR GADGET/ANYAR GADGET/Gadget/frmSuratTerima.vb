...
Public Class frmSuratTerima
    ...
    Private Sub picBrowsBusinessPartner_Click(sender As Object, e As EventArgs) Handles picBrowsBusinessPartner.Click
        frmBrowseBusinessPartnerSuratTerima.ShowDialog()
    End Sub
    ...
    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles PictureBox3.Click
        frmBrowseItemMasterDataSuratTerima.ShowDialog()
    End Sub
    ...
    Private Sub btnProses_Click(sender As Object, e As EventArgs) Handles btnProses.Click
        ...
        Call AU_SISTER_SJ("CEKFIELD-ST")

        If MstrErrorCode <> "" Then
            Exit Sub
        Else
            Call AU_SISTER_SJ("ADD-ST")
    ...
    Private Sub picPrint_Click(sender As Object, e As EventArgs) Handles picPrint.Click
        ...
        reportDocument = New Surat_Terima_Anyar_Gadget_G002_01
