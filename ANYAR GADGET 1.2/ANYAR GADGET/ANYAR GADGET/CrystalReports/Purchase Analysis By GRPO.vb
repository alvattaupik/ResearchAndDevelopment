...
Public Class Purchase_Analysis_By_GRPO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Purchase Analysis By GRPO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ANYAR_GADGET.Purchase Analysis By GRPO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_KodeCabang() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedPurchase_Analysis_By_GRPO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Purchase_Analysis_By_GRPO = New Purchase_Analysis_By_GRPO()
        rpt.Site = Me.Site
        Return rpt
    End Function
