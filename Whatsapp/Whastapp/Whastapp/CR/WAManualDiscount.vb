...
Public Class WAManualDiscount
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Whastapp.WAManualDiscount.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedWAManualDiscount
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As WAManualDiscount = New WAManualDiscount()
        rpt.Site = Me.Site
        Return rpt
    End Function
