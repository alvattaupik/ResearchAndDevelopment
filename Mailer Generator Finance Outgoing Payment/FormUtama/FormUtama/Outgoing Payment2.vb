...
Public Class Outgoing_Payment2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OutgoingPayment.Outgoing Payment2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedOutgoing_Payment2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Outgoing_Payment2 = New Outgoing_Payment2()
        rpt.Site = Me.Site
        Return rpt
    End Function
