...
Module ModKoneksi
    ...
    Public Sub KoneksiDatabaseEmail()
        ...
        strKoneksi2 = "data source=" & strLokasiDBEmail & ";user id=" & strusernameDatabaseEmail & ";password=" & strPassswordDatabaseEmail & ";initial catalog=" & strNamaDatabaseEmail & ";MultipleActiveResultSets=True  "
