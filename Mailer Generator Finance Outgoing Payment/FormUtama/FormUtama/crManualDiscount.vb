...
Public Class crManualDiscount
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "OutgoingPayment.crManualDiscount.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrManualDiscount
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crManualDiscount = New crManualDiscount()
        rpt.Site = Me.Site
        Return rpt
    End Function
