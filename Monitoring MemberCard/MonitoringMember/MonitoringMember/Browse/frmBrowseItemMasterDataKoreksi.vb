...
Public Class frmBrowseItemMasterDataKoreksi
    ...
    Private Sub dgvBusinessPartner_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvItemMasterData.CellContentClick
        CType(frmMainMenu.ActiveMdiChild, frmLainnya).txtKode.Text = dgvItemMasterData.Rows(e.RowIndex).Cells(0).Value()
        CType(frmMainMenu.ActiveMdiChild, frmLainnya).txtDeskripsi.Text = dgvItemMasterData.Rows(e.RowIndex).Cells(1).Value()
        Me.Close()
