        ...
        If GlobalstrJenisSurat = "Berita Acara Penyelesaian" Then
            ...
            For Each drr As DataGridViewRow In dgDaftarItem.SelectedRows
                ...
                For i2 As Int32 = 0 To drr.Cells.Count - 1
                    ...
                    For barisatas As Integer = 0 To FormBuatSuratIT.dgItem.RowCount - 1

                        If FormBeritaAcaraPenyelesaian.dgItem.Rows(barisatas).Cells(0).Value = dgDaftarItem.Rows(intBarisNow).Cells(0).Value Then
                            BolDuplikat = True
                ...
                If JumlahDuplikat > 0 Then
                    Exit Sub
                Else
                    FormBeritaAcaraPenyelesaian.dgItem.Rows.Add(row2)
                    Me.Close()
                End If
        ...
        Else
            For Each drr As DataGridViewRow In dgDaftarItem.SelectedRows
                ...
                For i2 As Int32 = 0 To drr.Cells.Count - 1
                    ...
                    For barisatas As Integer = 0 To FormBuatSurat.dgItem.RowCount - 1

                        If FormBuatSurat.dgItem.Rows(barisatas).Cells(0).Value = dgDaftarItem.Rows(intBarisNow).Cells(0).Value Then
                            BolDuplikat = True
                            JumlahDuplikat = JumlahDuplikat + 1
                        Else
                ...
                If JumlahDuplikat > 0 Then
                    Exit Sub
                Else
                    FormBuatSurat.dgItem.Rows.Add(row2)
                    Me.Close()
                End If
        ...
        If GlobalstrJenisSurat = "Berita Acara Penyelesaian" Then
            ...
            For Each drr As DataGridViewRow In dgDaftarItemLainnya.SelectedRows
                ...
                For i2 As Int32 = 0 To drr.Cells.Count - 1
                    ...
                    For barisatas As Integer = 0 To FormBeritaAcaraPenyelesaian.dgItem.RowCount - 1

                        If FormBeritaAcaraPenyelesaian.dgItem.Rows(barisatas).Cells(0).Value = dgDaftarItemLainnya.Rows(intBarisNow).Cells(0).Value Then
                            BolDuplikat = True
                            JumlahDuplikat = JumlahDuplikat + 1
                        Else
            ...
            For Each drr As DataGridViewRow In dgDaftarItemLainnya.SelectedRows
                ...
                For i2 As Int32 = 0 To drr.Cells.Count - 1
                    ...
                    For barisatas As Integer = 0 To FormBuatSurat.dgItem.RowCount - 1
                        ...
                        If FormBuatSurat.dgItem.Rows(barisatas).Cells(0).Value = dgDaftarItemLainnya.Rows(intBarisNow).Cells(0).Value Then
                            BolDuplikat = True
                            JumlahDuplikat = JumlahDuplikat + 1
                        Else
