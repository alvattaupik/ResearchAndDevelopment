...
Public Class FormBusinessPartner
    ...
    Private Sub dgDaftarCabang_Click(sender As Object, e As EventArgs) Handles dgDaftarCabang.Click
        ...
        If GlobalstrJenisSurat = "Berita Acara Penyelesaian" Then
            FormBeritaAcaraPenyelesaian.txtKepada.Text = dgDaftarCabang.Item(0, dgDaftarCabang.CurrentRow.Index).Value
            FormBeritaAcaraPenyelesaian.txtAlamat.Text = dgDaftarCabang.Item(1, dgDaftarCabang.CurrentRow.Index).Value
            FormBeritaAcaraPenyelesaian.txtNoTelepon.Text = dgDaftarCabang.Item(2, dgDaftarCabang.CurrentRow.Index).Value
            Me.Close()

        Else

            FormBuatSurat.txtPenerima.Text = dgDaftarCabang.Item(0, dgDaftarCabang.CurrentRow.Index).Value
            FormBuatSurat.txtAlamatPenerima.Text = dgDaftarCabang.Item(1, dgDaftarCabang.CurrentRow.Index).Value
            FormBuatSurat.txtNoTelpPenerima.Text = dgDaftarCabang.Item(2, dgDaftarCabang.CurrentRow.Index).Value
            Me.Close()
        End If
    ...
    Private Sub dgDaftarvendor_Click(sender As Object, e As EventArgs) Handles dgDaftarvendor.Click
        If GlobalstrJenisSurat = "Berita Acara Penyelesaian" Then
            FormBeritaAcaraPenyelesaian.txtKepada.Text = dgDaftarvendor.Item(0, dgDaftarvendor.CurrentRow.Index).Value
            FormBeritaAcaraPenyelesaian.txtAlamat.Text = dgDaftarvendor.Item(1, dgDaftarvendor.CurrentRow.Index).Value
            FormBeritaAcaraPenyelesaian.txtNoTelepon.Text = dgDaftarvendor.Item(2, dgDaftarvendor.CurrentRow.Index).Value
            Me.Close()
        Else
            FormBuatSurat.txtPenerima.Text = dgDaftarvendor.Item(0, dgDaftarvendor.CurrentRow.Index).Value
            FormBuatSurat.txtAlamatPenerima.Text = dgDaftarvendor.Item(1, dgDaftarvendor.CurrentRow.Index).Value
            FormBuatSurat.txtNoTelpPenerima.Text = dgDaftarvendor.Item(2, dgDaftarvendor.CurrentRow.Index).Value
            Me.Close()
        End If
    End Sub
End Class