...
Public Class Form1
    ...
    Sub LoopDaftarPenerima()
        ...
        For i As Integer = 0 To dglistkontak.Rows.Count - 1
            _whatsAppApi.SendMessage(New MsgArgs(dglistkontak.Rows(i).Cells("NoHP").Value, dglistkontak.Rows(i).Cells("Pesan").Value))
    ...
    Sub LoopDaftarKirimDelivery()
        ...
        For i As Integer = 0 To dglistkontak.Rows.Count - 1
            ...
            Dim msgReplay = String.Format(dglistkontak.Rows(i).Cells("Pesan").Value)

            _whatsAppApi.SendMessage(New MsgArgs(dglistkontak.Rows(i).Cells("NoHP").Value, msgReplay, ""))
    ...
    Sub LoadDaftarSendWhatsapp()
        KoneksiDatabaseTraining()
        Dim command As SqlCommand
        command = New SqlCommand("_tmspSendWhatsappDelivery", Koneksi2)

        Dim adapter As New SqlDataAdapter(command)
        command.CommandType = CommandType.StoredProcedure

        command.Parameters.AddWithValue("@Tanggal", "20200728")
    ...
    Sub CekStatusRowDelivery()
        ...
        command.Parameters.AddWithValue("@Tanggal", "20200229")
        command.Parameters.AddWithValue("@Cabang", "003")
